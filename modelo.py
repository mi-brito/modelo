# Script: analisis_presupuesto_deforestacion.py
...
# Calcular deciles de presupuesto
...
features_def = ["PRESUPUESTO_L1","CLASE_5_pred_num","DEFORESTACION_L1"]
...
df_modelo_def.to_csv("predicciones_presupuesto_deforestacion.csv", index=False)
...
# Escenarios y gráficas
presupuestos = np.linspace(0, 200000, 20)
def_pred_list = []

for p in presupuestos:
    clase_pred = clf_pres.predict(pd.DataFrame({"PRESUPUESTO_L1":[p]}))
