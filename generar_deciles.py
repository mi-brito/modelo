...
# Leer datos
df_def = pd.read_csv("matriz_deforestacion.csv")
df_def = df_def.rename(columns={"clave_municipio": "CVE_MUNICIPIO"})

df_pres = pd.read_csv("matriz_presupuesto.csv")
...
# Transformar deforestación a formato largo
...
# Calcular deforestación anterior y Xn
...
# Calcular deciles de presupuesto por año
df["DECIL_PRES"] = df.groupby("ANIO")["PRESUPUESTO"].transform(
    lambda x: pd.qcut(x, 10, labels=False, duplicates="drop")+1
)

# Calcular score estandarizado
